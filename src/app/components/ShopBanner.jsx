...
const ShopBanner = () => {
  ...
  return (
    <div className="w-full bg-gray-100 py-10 flex justify-center">
      <div className="w-11/12 mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
        {items.map((item, index) => (
          <motion.div
            key={index}
            className={`p-6 rounded-lg shadow-md flex flex-col sm:flex-row items-center ${item.bgColor}`}
